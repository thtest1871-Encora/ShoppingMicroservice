...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleInsufficientStock(InsufficientStockException ex) {
        return buildResponse(HttpStatus.BAD_REQUEST, ex.getMessage(), "Insufficient Stock");
    }
    ...
    public ResponseEntity<Map<String, Object>> handleRestClientError(RestClientException ex) {
        return buildResponse(HttpStatus.BAD_GATEWAY, "Error communicating with Product service", "Service Unavailable");
    }
